...
async function createBusinessHandler(req: NextRequest) {
  try {
    ...
    if (!body.userId) {
      ...
      console.log("Using userId from token:", body.userId);
    }
    ...
    try {
      ...
      console.log("MongoDB ready state:", dbConnection.connection.readyState);
    ...
    console.log("Looking for user with ID:", String(userId));
    ...
    console.log("Creating business with userId:", String(userId));
    ...
    try {
      ...
      console.log("Business created successfully. ID:", String(business._id));
      ...
      console.log("Business verified in database:", String(savedBusiness._id));
      console.log("Business collection:", savedBusiness.collection.name);
      console.log("Business document saved at:", savedBusiness.createdAt);
