...
export function generateWelcomeEmail(variables: { fname: string }): string {
  const content = `
    ...
    <p class="body-text">Hi ${variables.fname},</p>
...
export function generateBookingConfirmationEmail(variables: {
  ...
  const content = `
    ...
    <p class="body-text">
      Your booking with ${variables.businessName} has been confirmed.
    </p>
...
export function generateBookingCompleteEmail(variables: {
  ...
  const content = `
    ...
    <p class="body-text">
      Your booking with [${variables.shopperName}] has been marked as completed, and your payout has now been processed.
    </p>
...
export function generateCancellationBusinessEmail(variables: {
  ...
  const content = `
    ...
    <p class="body-text">Hi [${variables.businessName}],</p>
    
    <p class="body-text">
      We regret to inform you that your recent booking by [${variables.shopperName}] for [${variables.serviceName}] on [${variables.date}] has been cancelled.
    </p>
...
export function generateBusinessApprovedEmail(variables: {
  ...
  const content = `
    ...
    <p class="body-text">Hi ${variables.ownerName},</p>
    
    <p class="body-text">
      Great news! Your business <strong>${variables.businessName}</strong> has been approved and is now live on ouiimi.
    </p>
...
export function generateNewBookingToBusinessEmail(variables: {
  ...
  const content = `
    ...
    <p class="body-text">
      You have received a new booking request for <strong>${variables.serviceName}</strong>.
    </p>
...
export function generateServiceCompletedToCustomerEmail(variables: {
  ...
  const content = `
    ...
    <p class="body-text">Hi ${variables.customerName},</p>
    
    <p class="body-text">
      Your service <strong>${variables.serviceName}</strong> with ${variables.businessName} has been marked as completed.
    </p>
...
export function generateCancellationToCustomerEmail(variables: {
  ...
  const content = `
    ...
    <p class="body-text">
      Your booking for <strong>${variables.serviceName}</strong> with ${variables.businessName} on ${variables.date} at ${variables.time} has been cancelled.
    </p>
...
export function generateBusinessRejectedEmail(variables: {
  ...
  const content = `
    ...
    <p class="body-text">
      We regret to inform you that your application for <strong>${variables.businessName}</strong> has been declined.
    </p>
    
    <p class="body-text">
      <strong>Reason:</strong> ${variables.rejectionReason}
    </p>
...
export function generateBusinessSuspendedEmail(variables: {
  ...
  const content = `
    ...
    <p class="body-text">
      Your account for <strong>${variables.businessName}</strong> has been suspended.
    </p>
    
    <p class="body-text">
      <strong>Reason:</strong> ${variables.suspensionReason}
    </p>
